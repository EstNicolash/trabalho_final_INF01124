...
/*
 ...
 list_of_ids: lista de id's aos quais foi atribuída a tag, serve como flag de nodo terminador,
  sendo == NULL se não é terminador de palavra, caso contrário,
  contém a lista de ids de jogadores que possuem aquela tag
  last_of_list: ponteiro para o útlimo elemento da lista, para acelerar a inclusão de elementos
*/
struct tag_trienode {
  char value;
...
tag_trienode *initialize_tag_trienode(
